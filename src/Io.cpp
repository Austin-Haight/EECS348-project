...
void InputOutput::setUserString()
{
    cout << "Enter a valid expression: " << endl;
    getline(cin, userString);
}

string InputOutput::getUserString()
{
    return userString;
}

void InputOutput::startScreen()
{
...
bool InputOutput::validateString()
{
...
void InputOutput::printEvaluatorError(EvalResult res) {
    cout << "----------------------------" << endl;
...
void InputOutput::printOutput(string output)
{
